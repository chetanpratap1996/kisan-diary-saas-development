...
export async function POST(
  ...
  try {
    ...
    const expenseMapping: Record<string, "seeds" | "fertilizers" | "pesticides" | "diesel" | "labor" | "tractor_rent" | "irrigation_cost" | "machinary" | "other"> = {
      beej: "seeds",
      khad: "fertilizers",
      dawai: "pesticides",
      majdoor: "labor",
    ...
    const dbExpenseCategory = expenseMapping[data.category] || "other";
