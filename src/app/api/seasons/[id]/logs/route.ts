...
export async function POST(
  ...
  try {
    ...
    const typeMapping: Record<string, "sowing" | "irrigation" | "spray" | "harvest" | "majdoor" | "other"> = {
      paani: "irrigation",
      dawai: "spray",
      beej: "sowing",
      majdoor: "majdoor",
    ...
    const dbActivityType = typeMapping[data.activityType] || "other";
    ...
    if (data.amount) {
      const expenseMapping: Record<string, "seeds" | "fertilizers" | "pesticides" | "labor" | "other"> = {
        beej: "seeds",
        dawai: "pesticides",
        majdoor: "labor",
        other: "other"
      ...
      let expenseCategory: "seeds" | "fertilizers" | "pesticides" | "diesel" | "labor" | "tractor_rent" | "irrigation_cost" | "machinary" | "other" = "other";
      if (data.activityType === "beej") expenseCategory = "seeds";
      else if (data.activityType === "dawai") expenseCategory = "pesticides";
      else if (data.activityType === "majdoor") expenseCategory = "labor";
