...
import { BarChart3, Sprout, TrendingUp, TrendingDown, Wheat, Plus } from "lucide-react";
  ...
  if (!activeSeason) {
    return (
      <div className="min-h-screen bg-gray-50 flex flex-col items-center justify-center p-6">
        ...
        <Button onClick={() => router.push("/app/farms")} className="gap-2">
          <Sprout className="w-4 h-4" strokeWidth={1.5} /> फसल शुरू करें
        </Button>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-24">
      ...
      <div className={`px-4 pt-12 pb-8 ${summary.isProfit ? "bg-gradient-to-r from-green-600 to-emerald-700" : "bg-gradient-to-r from-red-500 to-rose-700"}`}>
        <h1 className="text-white text-xl font-bold mb-1 flex items-center gap-2.5">
        ...
        <div className="bg-white/20 rounded-2xl p-4 mt-3">
          <p className="text-white/70 text-xs mb-1 flex items-center gap-1">
            {summary.isProfit 
              ? <TrendingUp className="w-3.5 h-3.5 text-green-300" strokeWidth={2} />
              : <TrendingDown className="w-3.5 h-3.5 text-red-300" strokeWidth={2} />
            }
      ...
      <div className="px-4 mb-6">
        ...
        >
          <Wheat className="w-4 h-4" /> कटाई जोड़ें / Harvest Log
        </Button>
      </div>
      ...
      <div className="px-4 mb-6">
        <Button
          ...
          variant="outline"
          className="w-full h-12 border-blue-200 text-blue-700 hover:bg-blue-50 font-bold rounded-xl"
        >
          📈 सभी सीज़न का प्रॉफिट (All-Time P&L) देखें
        </Button>
      </div>
