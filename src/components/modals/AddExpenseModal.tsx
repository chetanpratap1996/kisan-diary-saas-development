...
import { TrendingDown, CalendarDays, AlertTriangle } from "lucide-react";
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md mx-auto rounded-[2rem] p-0 overflow-hidden border-0 shadow-2xl">
        <div className="px-6 py-6 bg-red-50 border-b border-red-100 flex flex-col items-center">
          <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-md mb-3 border border-red-100">
            <TrendingDown className="w-8 h-8 text-red-500" strokeWidth={1.5} />
          </div>
